    ...
    return (
        <>
            <Page title="Polityka Prywatności">
                <p>Poniższa Polityka Prywatności określa <strong>zasady zapisywania i uzyskiwania dostępu do danych na Urządzeniach Użytkowników</strong> korzystających z Serwisu do celów świadczenia usług drogą elektroniczną przez Administratora oraz <strong>zasady gromadzenia i przetwarzania danych osobowych Użytkowników</strong>, które zostały podane przez nich osobiście i dobrowolnie za pośrednictwem narzędzi dostępnych w Serwisie.</p><p>Poniższa Polityka Prywatności jest integralną częścią <a style={linkStyle} href="/regulamin">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
                <h2 style={headerStyle} >§1 Definicje</h2>
                <ul>
                    <li>
                        <p><strong>Serwis</strong> - serwis internetowy "Ceramint" działający pod adresem https://ceramint.pl</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Natalia Białek" zamieszkała w Warszawie, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p></li> <li><p><strong>Użytkownik</strong> - osoba fizyczna, dla której Administrator świadczy usługi drogą elektroniczną za pośrednictwem Serwisu.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Ograniczenie przetwarzania</strong> - oznacza oznaczenie przechowywanych danych osobowych w celu ograniczenia ich przyszłego przetwarzania </p></li>
                    <li>
                ...
                <h2 style={headerStyle} >§2 Inspektor Ochrony Danych</h2>
                ...
                <h2 style={headerStyle} >§3 Rodzaje Plików Cookies</h2>
                <ul>
                    <li>
                ...
                <h2 style={headerStyle} >§4 Bezpieczeństwo składowania danych</h2>
                <ul>
                    <li>
                    ...
                    <li>
                        <p><strong>Kontrola plików Cookie</strong>
                            <ul>
                                ...
                                <li>
                                    <p>Informacje o sposobie wyłączenia plików Cookie w najpopularniejszych przeglądarkach komputerowych dostępne są na stronie: <a style={linkStyle} rel="external" href="https://nety.pl/jak-wylaczyc-pliki-cookie/">jak wyłączyć cookie</a> lub u jednego ze wskazanych dostawców:
                                        <ul>
                                            <li>
                                                <a style={linkStyle} rel="nofollow external" href="https://support.google.com/accounts/answer/61416?co=GENIE.Platform%3DDesktop&#038;hl=pl">Zarządzanie plikami cookies w przeglądarce <strong>Chrome</strong></a>
                                            </li>
                                            <li><a style={linkStyle} rel="nofollow external" href="https://help.opera.com/pl/latest/web-preferences/">Zarządzanie plikami cookies w przeglądarce <strong>Opera</strong></a>
                                            </li>
                                            <li>
                                                <a style={linkStyle} rel="nofollow external" href="https://support.mozilla.org/pl/kb/blokowanie-ciasteczek">Zarządzanie plikami cookies w przeglądarce <strong>FireFox</strong></a>
                                            </li>
                                            <li><a style={linkStyle} rel="nofollow external" href="https://support.microsoft.com/pl-pl/help/4027947/microsoft-edge-delete-cookies">Zarządzanie plikami cookies w przeglądarce <strong>Edge</strong></a>
                                            </li>
                                            <li>
                                                <a style={linkStyle} rel="nofollow external" href="https://support.apple.com/pl-pl/guide/safari/sfri11471/mac">Zarządzanie plikami cookies w przeglądarce <strong>Safari</strong></a>
                                            </li>
                                            <li>
                                                <a style={linkStyle} rel="nofollow external" href="https://windows.microsoft.com/pl-pl/internet-explorer/delete-manage-cookies#ie=ie-11">Zarządzanie plikami cookies w przeglądarce <strong>Internet Explorer 11</strong></a>
                                            </li>
                                        </ul>
                                    </p>
                                </li>
                ...
                <h2 style={headerStyle} >§5 Cele do których wykorzystywane są pliki Cookie</h2>

                <ul id="cele">
                    <li>Usprawnienie i ułatwienie dostępu do Serwisu</li>
                    <li>Personalizacja Serwisu dla Użytkowników</li>
                </ul>
                <h2 style={headerStyle} >§6 Cele przetwarzania danych osobowych</h2>
                ...
                <h2 style={headerStyle} >§7 Pliki Cookies Serwisów zewnętrznych</h2>
                ...
                <h2 style={headerStyle} >§8 Rodzaje gromadzonych danych</h2>
                ...
                <h2 style={headerStyle} >§9 Dostęp do danych osobowych przez podmioty trzecie</h2>
                ...
                <h2 style={headerStyle} >§10 Sposób przetwarzania danych osobowych</h2>
                ...
                <h2 style={headerStyle} >§11 Podstawy prawne przetwarzania danych osobowych</h2>
                ...
                <h2 style={headerStyle} >§12 Okres przetwarzania danych osobowych</h2>
                <p><strong>Dane osobowe podane dobrowolnie przez Użytkowników:</strong></p>
                ...
                <h2 style={headerStyle} >§13 Prawa Użytkowników związane z przetwarzaniem danych osobowych</h2>
                <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
                <ul>
                    <li>
                ...
                <h2 style={headerStyle} >§14 Kontakt do Administratora</h2>
                <p>Z Administratorem można skontaktować się w jeden z poniższych sposobów</p>
                <ul>
                    <li>
                        <p><strong>Adres poczty elektronicznej</strong> - natalie.protein@gmail.com</p>
                    </li>
                    <li>
                        <p><strong>Połączenie telefoniczne</strong> - +48 111 111 111</p>
                    </li>
                    <li>
                ...
                <h2 style={headerStyle} >§15 Wymagania Serwisu</h2>
                <ul>
                    <li>
                ...
                <h2 style={headerStyle} >§16 Linki zewnętrzne</h2>
                ...
                <h2 style={headerStyle} >§17 Zmiany w Polityce Prywatności</h2>
                <ul>
                    <li>
