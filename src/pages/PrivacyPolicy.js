    ...
    <>
      <Page title="Polityka Prywatności">
        ...
        <p>
          ...
          <a href="/regulamin">Regulaminu Serwisu</a>, który określa zasady,
          prawa i obowiązki Użytkowników korzystających z Serwisu.
        </p>
        <h2 className={styles.legal__header}>§1 Definicje</h2>
        <ul>
          <li>
            <p>
              <strong>Serwis</strong> - serwis internetowy "Ceramint" działający
              pod adresem https://ceramint.pl
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              osoba fizyczna "Natalia Białek" zamieszkała w Warszawie,
        ...
        <h2 className={styles.legal__header}>§2 Inspektor Ochrony Danych</h2>
        <p>
        ...
        <h2 className={styles.legal__header}>§3 Rodzaje Plików Cookies</h2>
        <ul>
          <li>
            <p>
        ...
        <h2 className={styles.legal__header}>
        ...
        <h2 className={styles.legal__header}>§8 Rodzaje gromadzonych danych</h2>
        <p>
        ...
        <h2 className={styles.legal__header}>§14 Kontakt do Administratora</h2>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              natalie.protein@gmail.com
            </p>
          </li>
          <li>
            <p>
              <strong>Połączenie telefoniczne</strong> - +48 111 111 111
            </p>
          </li>
          <li>
            <p>
        ...
        <h2 className={styles.legal__header}>§15 Wymagania Serwisu</h2>
        <ul>
          <li>
            <p>
        ...
        <h2 className={styles.legal__header}>§16 Linki zewnętrzne</h2>
        <p>
